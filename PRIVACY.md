...
The extension reads the local Codex model cache only to populate the model and reasoning selectors. It does not upload that cache. Consent for the optional Max visibility repair is stored in VS Code extension global state.
